...
import so.codex.codexbl.providers.usertoken.UserTokenPreferences
import so.codex.codexbl.providers.usertoken.UserTokenProvider
...
val providersModule = module {
    ...
    single<UserTokenDAO>(named("preferences")) {
